...
# 
QString Ch::atone(QString a, bdc)
...
def Ch::genStrNum(const QString s, QString *ch, n):
    ch.stdscr.clear()
    *n = 0
...
# \return true si a < b.
# 
def Ch::sort_i(const QString &a, const QString &b):
...
# 
def Ch::inv_sort_i(const QString &a, const QString &b):
    return QString::compare(atone(a), atone(b), Qt::CaseInsensitive) > 0
...
QString Ch::ajoutSuff(QString fq, QString suffixe, QString l_etym, accent)
    illius = False
    cesure = False
    sansAccent = False
    if accent > 7:
