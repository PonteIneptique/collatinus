...
# 
Radical::Radical(QString g, n, QObject *parent)
...
# 
Lemme::Lemme(const QString linea, const origin, QObject *parent)
...
# \brief Ajoute le radical r de numéro i à la map des
       # radicaux du lemme.
# 
def Lemme::ajRadical(i, Radical *r):
...
# 
def Lemme::ajTrad(QString t, QString l):
...
# 
QString Lemme::humain(html, QString l, nbr)
    QString res
    QString tr
...
# 
QString Lemme::oteNh(QString g, &nh)
    c = g.right(1).toInt()
    if c > 0:
        nh = c
        g.chop(1)
...
# \brief Renvoie true si le lemme est une forme
       ...
       # du lexique.
# 
Lemme::renvoi() { return _indMorph.contains("cf. "); }
#
...
# 
Lemme::operator<(const Lemme &l) const
    #qDebug()<<"operator<"<<_gr
