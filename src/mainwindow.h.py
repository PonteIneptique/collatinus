...
class MainWindow : public QMainWindow
   ...
   public:
    ...
    void tagger(QString t, p); # Je voudrais créer dans MainWindow l'interface du tagger.


   private slots:
    void afficheLemsDic(litt = False,
                        prim = True);  # ligne de saisie
    ...
    void changePageDjvu(int p, prim = True)
    void clicAnte()
    void clicAnteW()
    void clicPost()
    void clicPostW()
   ...
   public slots:
    void afficheLemsDic(QStringList ll, no = 0)
    void afficheLemsDicW(QStringList ll, no = 0)
   ...
   private:
    ...
    QAction *zoomAct
    # QAction *undoAct
    # widgets, et fonctions du dock dictionnaires
    ...
    ListeDic listeD
    QStringList ldic
    # les mêmes, le widget dictionnaires
