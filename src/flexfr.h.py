...
class Verbe
   ...
   public:
    ...
    virtual QString elide(QString A, B)
    virtual QString Pron(int P, F, refl)
    virtual QString RD(QString R, D)
    virtual QString compose(QString A, P, T, M, V)
    # temps
    ...
    virtual QString PP()
    # procdure de flexion
    virtual QString conjugue(int P, T, M, V, pr = False,
                             g = 0, n = 0)
...
class TVpleuvoir : public TVsst
   public:
    ...
    virtual QString SubjPres(int P)
    virtual QString PP()
    virtual QString conjugue(int P, T, M, V, Pr)
...
class TVfalloir : public TVvaloir
   public:
    ...
    virtual QString IndPs(int P)
    virtual QString SubjPres(int P)
    QString conjugue(int P, T, M, V, pr)
...
def verbe_m(self, inf):
QString conjugue(QString inf, P = 1, T = 1, M = 1, V = 1,
                 Pr = False, g = 0, n = 0)
...
class Adjectif
   ...
   public:
    ...
    virtual QString accorde(int g, n)
