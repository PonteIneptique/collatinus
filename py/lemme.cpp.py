...
######/
'''*
 * \fn Radical.Radical (QString g, n, *parent)
 * \brief Créateur de la classe Radical. g est la forme
 *        canonique avec ses quantités, est le numéro du radical
 '''
Radical.Radical(QString g, n, *parent)
